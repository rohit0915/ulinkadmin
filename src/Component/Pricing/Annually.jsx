...
function Annually() {
    ...
    return (
        <>
            <div className="home_para text-center mt-2">Price shown in USD per Year</div>
            <Grid className="Component_main_grid p-3 ">
                ...
                <Grid item md={6} className="p-3">
                    <Card className="p-3 card_background_free">
                        <div className="Premium_data_formatting2">PRO $50<br /> Per Year</div>
                        <div className="mt-3 Premium_data_content2"> All the benefits of Paid PLUS enhanced features to help you connect your online identity</div>
                        {monthlydata.map((item, index) => (
